...
function prrecipe_recipe_auth_alt_form_shortcode() {
  ...
  //explode( string:separator, array|object) ---> turns array into string
...
function prrecipe_alt_authenticate( $user, $username, $password ){
  ...
  //join( string:separator, array|object) ---> merges array into string
